    ...
    <tbody class="block md:table-row-group">
        ...
        <tr class="bg-gray-300 border border-grey-500 md:border-none block md:table-row">
            ...
            <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span
                    class="inline-block w-1/3  font-bold">{!! $note->titre !!}</td>
            <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span
                    class="inline-block w-1/3  font-bold">{!! $note->description !!}</td>
            <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span
                    class="inline-block w-1/3  font-bold"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
            ...
            <td class="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span
                    class="inline-block w-1/3  font-bold">{{$note->user->role->name}}</span></td>
